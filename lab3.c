...
void printStruct(struct inst instruct)
{
    ...
    switch (instruct.op)
    {
      case ADD: opcodeString = "add";
      case ADDI: opcodeString = "addi";
      case SUB: opcodeString = "sub";
      case MULT: opcodeString = "mult";
      case BEQ: opcodeString = "beq";
      case LW: opcodeString = "lw";
      case SW: opcodeString = "sw";
